...
export default {
  ...
  <div title="Bookings CRUD" class="sm:max-w-fit">
    ...
    <div class="mt-5 flex justify-between">
        <div>
            <SrcLink href="https://github.com/NetCoreTemplates/vue-mjs/blob/main/MusicTypeChat.ServiceModel/Bookings.cs" />
            <SrcLink href="https://github.com/NetCoreTemplates/vue-mjs/blob/main/MusicTypeChat/wwwroot/Pages/Bookings.mjs" />
        </div>
        <div>
